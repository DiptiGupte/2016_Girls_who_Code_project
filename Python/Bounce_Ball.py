...
xlocation = random.randint(0,700)
ylocation = random.randint(0,500)
xspeed = random.randint(-10,10)
yspeed = random.randint(-10,10)
ballsize = random.randint(10,30)
xlocation2 = random.randint(0,700)
ylocation2 = random.randint(0,500)
...
# -------- Main Program Loop -----------
ball = BouncingBall(xlocation, ylocation, xspeed, yspeed, ballsize)
ball2 = BouncingBall(xlocation2, ylocation2, xspeed, yspeed, ballsize)
